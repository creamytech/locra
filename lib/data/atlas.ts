...
export const DESTINATIONS: Destination[] = [
  {
    ...
    story: "A volcanic majesty where the wind carries the scent of salt and ancient history. Our Santorini pieces are woven with the lightness of the Cycladic breeze.",
  ...
  },
  {
    ...
    story: "Centuries of quiet craftsmanship. Pieces from Kyoto reflect the wabi-sabi philosophy—perfection in imperfection.",
